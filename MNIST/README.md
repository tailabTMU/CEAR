...
> ⚠️ **Important:**  
> The help string says “1: Teacher …” but the actual `__main__` mapping is:
...
- Distillation uses teacher predictions as “soft labels”: `soft_labels = teacher.predict(x_train)`
...
## ⚠️ Path Mismatches (you may need to adjust depending on where your models are saved):
